                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                        ...
                        <div className="relative  overflow-hidden ">
                            <div
                                ...
                                <span className="absolute left-10 top-10 z-0 h-20 w-20 rounded-full bg-sky-500 transition-all duration-300 group-hover:scale-[10]"></span>
